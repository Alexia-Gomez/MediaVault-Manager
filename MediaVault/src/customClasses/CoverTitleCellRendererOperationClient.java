...
public class CoverTitleCellRendererOperationClient extends JPanel implements TableCellRenderer{
	...
	public CoverTitleCellRendererOperationClient() {
	...
	public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        Operation op = (Operation) table.getModel().getValueAt(modelRow, 5);
        Client client = op.getCliente();
