...
public class GamesModel {
	...
	public ArrayList<Game> get() {
		games.clear();
		String query = "SELECT product_id, title, platform, classification, release_date, genre, rent_stock, sale_stock, cover, sale_price, rent_price FROM Products WHERE product_type = 'videogame'";
	...
	public boolean delete(int product_id) {
		String query = "DELETE FROM Products WHERE product_id = ? AND product_type = 'videogame'";
		Connection connection = ConexionBD.getConexion();
	...
	public boolean update(Game product, int product_id) {
